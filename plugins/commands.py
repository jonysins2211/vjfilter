    ...
    if len(message.command) != 2:
        if PREMIUM_AND_REFERAL_MODE == True:
            buttons = [[
                ...
                InlineKeyboardButton('Dᴇᴀʟꜱ Cʜᴀɴɴᴇʟ', url=f'https://t.me/amazon_flipkartt_offers'),
                InlineKeyboardButton('ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ', url=GRP_LNK)
            ],[
